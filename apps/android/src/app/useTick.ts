 ...
 * on every render, this just makes sure a render keeps happening. Identical to
 * `apps/web/src/app/useTick.ts` — `setInterval`/`clearInterval` are ordinary RN globals.
 */
