 ...
 * can hand the server a credential at handshake time. See `apps/api/src/routes/live.ts`.
 *
 * Backoff is deterministic, without jitter: `apps/web/src/sync/**` is covered by the no-ambient-
